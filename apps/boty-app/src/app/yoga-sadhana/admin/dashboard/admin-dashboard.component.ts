...
export class AdminDashboardComponent {
  ...
  async runSeed() {
    ...
    this.seedStatus = 'Inicializando datos...';
    try {
      await this.shopService.seedDatabase();
      await this.seedService.seedAll();
      this.seedStatus = '✅ Datos inicializados correctamente!';
    } catch (e) {
      this.seedStatus = '❌ Error: ' + (e as Error).message;
      console.error(e);
    } finally {
